...
@php
    ...
    $hide_subscription_module = isset(json_decode($preferences->custom_mode)->hide_subscription_module)
        ? json_decode($preferences->custom_mode)->hide_subscription_module
        : 0;
@endphp
